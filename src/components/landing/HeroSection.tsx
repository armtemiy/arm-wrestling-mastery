  ...
  return (
    ...
    >
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        />
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] sm:w-[900px] lg:w-[1200px] h-[400px] sm:h-[600px] lg:h-[800px] bg-primary rounded-full blur-[150px] sm:blur-[200px] lg:blur-[250px] opacity-[0.075]" />
        <div className="absolute bottom-0 right-0 w-[400px] sm:w-[600px] lg:w-[800px] h-[400px] sm:h-[600px] lg:h-[800px] bg-secondary rounded-full blur-[120px] sm:blur-[160px] lg:blur-[200px] opacity-[0.055]" />
      </div>
      ...
      >
        <div className="mx-auto flex w-full max-w-[980px] flex-col items-center">
          <div className="text-center mb-4 sm:mb-6 md:mb-8">
            ...
            >
              <span className="block text-foreground text-[clamp(2.2rem,8vw,5rem)] sm:text-[clamp(3.1rem,7vw,5.8rem)] leading-[0.96] mb-2 sm:mb-3">
                ВЫИГРЫВАЙ
              </span>
                ...
                <div
                  className={`absolute -bottom-3 sm:-bottom-5 left-1/2 h-1.5 sm:h-2 bg-gradient-to-r from-transparent via-primary to-transparent rounded-full blur-sm ${prefersReducedMotion ? "" : "transition-all duration-1000 delay-500"} ${
                    prefersReducedMotion || isLoaded
                      ? "w-32 sm:w-48 md:w-64 -translate-x-1/2 opacity-80"
                      : "w-0 -translate-x-1/2 opacity-0"
                  }`}
                  style={{
                    boxShadow:
                      "0 0 30px hsl(var(--primary)), 0 0 60px hsl(var(--secondary))",
                  }}
                />
              </span>
            </h1>
            ...
            >
              База Армтемия — закрытая система материалов, мышления и комьюнити
              для тех, кто хочет понимать борьбу, а не копировать чужие шаблоны.
            </p>
          </div>
          ...
          >
            <div className="relative group w-full sm:w-auto">
              <div
                className={`absolute -inset-1.5 bg-gradient-to-r from-primary to-secondary rounded-full blur-xl opacity-40 ${prefersReducedMotion ? "" : "group-hover:opacity-80 transition-opacity duration-500 animate-pulse-slow"}`}
              />
              <Button
                asChild
            ...
            >
              <span
                className={`absolute inset-0 bg-gradient-to-r from-primary/0 via-primary/10 to-primary/0 ${prefersReducedMotion ? "opacity-0" : "opacity-0 group-hover:opacity-100 transition-opacity"}`}
              />
              <MessageCircle
                size={18}
                className={`mr-2 sm:mr-2.5 text-primary ${prefersReducedMotion ? "" : "group-hover:scale-110 transition-transform"}`}
              />
