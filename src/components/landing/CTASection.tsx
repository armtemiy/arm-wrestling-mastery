...
const CTASection = () => {
  ...
  return <section ref={ref} className={`relative py-24 md:py-32 overflow-hidden bg-[hsl(var(--hero-bg))] transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
          ...
          <div className="relative">
            ...
            <div className="relative glass-strong rounded-3xl p-8 md:p-12 text-center">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-10">
                ...
                <Button asChild variant="cta" size="lg" className="rounded-full border-2 border-[hsl(0_0%_100%/0.2)] bg-[hsl(0_0%_100%/0.05)] hover:bg-[hsl(0_0%_100%/0.1)] text-[hsl(var(--hero-foreground))]">
              ...
              <div className="flex items-center justify-center gap-6 text-[hsl(var(--hero-foreground)/0.6)]">
                <a href="https://t.me/armtemiy" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
                  Канал @armtemiy
                </a>
                <span className="w-1 h-1 rounded-full bg-current" />
                <a href="https://t.me/assistemiy" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
                  Личка @assistemiy
                </a>
              </div>
            </div>
