              ...
              <div className="aspect-square rounded-3xl bg-gradient-to-br from-[hsl(0_0%_14%)] to-[hsl(0_0%_11%)] border border-[hsl(0_0%_100%/0.1)] overflow-hidden">
                <div className="w-full h-full flex items-center justify-center">
                  <div className="text-center p-8">
                    <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-[hsl(150_70%_45%/0.15)] flex items-center justify-center">
                      <MapPin size={28} className="text-[hsl(150_70%_50%)]" />
                    </div>
            ...
            <div>
              ...
              <div className="space-y-4 mb-8">
                {details.map((detail, index) => (
                  ...
                  >
                    <div className="w-10 h-10 rounded-xl bg-[hsl(150_70%_45%/0.15)] flex items-center justify-center group-hover:bg-[hsl(150_70%_45%/0.25)] group-hover:scale-110 transition-all duration-300">
                      <detail.icon className="text-[hsl(150_70%_50%)] group-hover:rotate-6 transition-transform duration-300" size={20} />
                    </div>
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center rounded-full bg-[hsl(150_70%_45%)] hover:bg-[hsl(150_70%_50%)] text-black font-semibold px-8 py-4 text-base shadow-[0_0_30px_hsl(150_70%_45%/0.3)] hover:shadow-[0_0_50px_hsl(150_70%_45%/0.5)] transition-all duration-300"
                >
